...
statAT = 			"rhs_SPG9M_MSV"; // alternatively: "rhs_Kornet_9M133_2_vdv"
...
statATBackpacks = 		["RHS_Kornet_Gun_Bag","RHS_Kornet_Tripod_Bag"];
...
genATLaunchers = ["rhs_weap_rpg26","rhs_weap_rshg2","rhs_weap_rpg7"];
